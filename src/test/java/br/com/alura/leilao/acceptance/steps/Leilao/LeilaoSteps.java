package br.com.alura.leilao.acceptance.steps.Leilao;
...
public class LeilaoSteps {
    ...
    public void preenche_o_formulario_com_dados_validos() {
        this.leiloesPage = this.novoLeilaoPage.preencheForm("PC", "1500", "11/02/2021");
    }
    ...
    public void o_novo_leilao_aparece_na_tabela() {
        this.leiloesPage.existe("PC", "1500", "11/02/2021", "fulano");
        this.browser.clean();
    }
